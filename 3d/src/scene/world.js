// talvi 3d — the world (blueprint Part B / Scene design).
//
...
//   - instrument panels      wireframe boxes with corner brackets, divider
//                            cells and a marked strip, plus a glow centre
...
export function buildWorld(scene) {
  ...
  const panelA = makePanel(12, 7, 3);
  panelA.group.position.set(0, 3.4, -16);
  scene.add(panelA.group);

  const panelB = makePanel(10, 6, 2);
  panelB.group.position.set(0, 3.4, -46);
  scene.add(panelB.group);
