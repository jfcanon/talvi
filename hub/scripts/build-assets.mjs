// Hub asset pipeline (v5). The 3D world is gone, so the client is a plain
// self-booting script again — no esbuild bundle, no three.js. build-assets
// embeds /h.css and /h.js as plain JS string exports so the worker serves
// them without a file read and without inlining anything in HTML (CSP
