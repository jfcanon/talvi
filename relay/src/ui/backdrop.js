// talvi relay — the quiet backdrop (blueprint P2).
//
// A still, faint 3D world behind the relay's pages — the prompt12 essence
// (cinematic atmosphere under layered UI) done in talvi's language: no photo,
// no fonts, no external assets, just fog, a dim grid, a few dim instrument
// panels off-axis, and very faint slow rain. Quiet by design:
//   - opacities are low so content stays the star,
