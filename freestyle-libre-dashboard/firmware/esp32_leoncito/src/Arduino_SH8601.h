// Vendored from waveshareteam/ESP32-S3-Touch-AMOLED-1.8 (examples/arduino/libraries/GFX_Library_for_Arduino), BSD-style as upstream Arduino_GFX. Upstream Arduino_GFX has no SH8601 driver.
#pragma once
