// Learn asset pipeline (PR2). Same shape as the hub/relay
// scripts/build-assets.mjs — embeds the learn /s.css and /s.js as plain JS
// string exports so the worker serves them without a file read and without
// inlining anything in HTML (CSP default-src 'none': a security decision
// driving a build decision).
//
